...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form_4_8_grid, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.wrappers :horizontal_radio_and_checkboxes_4_8_grid, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly
